      ...
      <div className='container mx-auto px-4 sm:px-6'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center'>
          ...
          <div className='relative z-20 order-1 lg:order-2'>
            ...
            <p className='text-sm sm:text-base text-gray-500 my-6 sm:my-8 leading-relaxed'>
              Transform your space into a reflection of your style. Our modern
              interior design approach brings harmony, texture, and creativity
              together to make every corner feel fresh, inviting, and uniquely
              yours.
            </p>
            ...
            <Button className='bg-gray-900 hover:bg-gray-800 text-white px-6 sm:px-8 py-4 sm:py-6 rounded-full text-sm sm:text-base'>
              Explore
            </Button>
          </div>
        </div>
